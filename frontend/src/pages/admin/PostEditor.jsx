            ...
            <div className="p-6 grid grid-cols-1 gap-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        {isCS && (
                            <Field label="Outcomes (one per line)">
                                <textarea
                                    ...
                                    onChange={(e) =>
                                        set("outcomes_text", e.target.value)
                                    }
                                    rows={4}
                    ...
                    <div className="space-y-4">
                        ...
                        <div
                            className="border border-mir-border bg-mir-surface p-6 min-h-[300px]"
                ...
                <Field label="Content *">
                    <RichEditor
                        ...
                        token={token}
                        folder={isCS ? "case-studies" : "blog"}
                        testId="admin-editor-content"
                        placeholder="Start writing… use the toolbar above to add headings, images, links and lists. Place your cursor anywhere and insert images on top, in the middle, in clusters — anywhere."
                    />
                </Field>
            </div>
        </div>
